...
Answer.
1+++.+++ There is that which waiteth to preserve, and is still stretching forth its hand,
...
Question.
2+++.+++ Wherein doth this unity consist?
...
Question.
4+++.+++ How is the unity interrupted?
...
Question.
5+++.+++ How may unity be recovered, if at any time decaying?
