...
The childlike fear is in the nature of the child;
and the more it grows in the true childlike nature,
...
The childlike fear is a promise of the new covenant;
...
in that childlike simplicity and innocent wisdom, whereof he is born.) Luke 18:17, John 3:3.
