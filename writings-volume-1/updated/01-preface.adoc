...
and a fourth (which is available on our website friendslibrary.com in
both physical and digital formats) was printed in 1863.
Although the language is a bit more archaic and the punctuation more cumbersome,
I hightly recommend these four volumes.
